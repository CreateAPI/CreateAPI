...
extension Paths {
    ...
    public struct APIs {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(workspace: String? = nil, api: PostRequest.API? = nil) -> Request<PostResponse> {
            .post(path, query: makePostQuery(workspace), body: PostRequest(api: api))
        }
...
extension Paths.APIs {
    public func apiID(_ apiID: String) -> WithAPIID {
        WithAPIID(path: "\(path)/\(apiID)")
    }

    public struct WithAPIID {
        /// Path: `/apis/{apiId}`
        public let path: String
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(api: PutRequest.API? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(api: api))
        }
...
extension Paths.APIs.WithAPIID {
    ...
    public struct Versions {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(version: PostRequest.Version? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(version: version))
        }
...
extension Paths.APIs.WithAPIID.Versions {
    public func apiVersionID(_ apiVersionID: String) -> WithAPIVersionID {
        WithAPIVersionID(path: "\(path)/\(apiVersionID)")
    }

    public struct WithAPIVersionID {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(version: PutRequest.Version? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(version: version))
        }
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var contracttest: Contracttest {
        Contracttest(path: path + "/contracttest")
    }

    public struct Contracttest {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/contracttest`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var documentation: Documentation {
        Documentation(path: path + "/documentation")
    }

    public struct Documentation {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/documentation`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    ...
    public struct Environment {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/environment`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var integrationtest: Integrationtest {
        Integrationtest(path: path + "/integrationtest")
    }

    public struct Integrationtest {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/integrationtest`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var monitor: Monitor {
        Monitor(path: path + "/monitor")
    }

    public struct Monitor {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/monitor`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var schemas: Schemas {
        Schemas(path: path + "/schemas")
    }

    public struct Schemas {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/schemas`
        public let path: String
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(schema: PostRequest.Schema? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(schema: schema))
        }
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID.Schemas {
    public func schemaID(_ schemaID: String) -> WithSchemaID {
        WithSchemaID(path: "\(path)/\(schemaID)")
    }

    public struct WithSchemaID {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/schemas/{schemaId}`
        public let path: String
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(schema: PutRequest.Schema? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(schema: schema))
        }
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID.Schemas.WithSchemaID {
    ...
    public struct Collections {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(workspace: String? = nil, _ body: PostRequest? = nil) -> Request<PostResponse> {
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    public var testsuite: Testsuite {
        Testsuite(path: path + "/testsuite")
    }

    public struct Testsuite {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/testsuite`
        public let path: String
...
extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID {
    ...
    public struct WithEntityType {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/{entityType}`
        public let path: String
    }
}

extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID.WithEntityType {
    public func entityID(_ entityID: String) -> WithEntityID {
        WithEntityID(path: "\(path)/\(entityID)")
    }

    public struct WithEntityID {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/{entityType}/{entityId}`
        public let path: String
    }
}

extension Paths.APIs.WithAPIID.Versions.WithAPIVersionID.WithEntityType.WithEntityID {
    public var syncWithSchema: SyncWithSchema {
        SyncWithSchema(path: path + "/syncWithSchema")
    }

    public struct SyncWithSchema {
        /// Path: `/apis/{apiId}/versions/{apiVersionId}/{entityType}/{entityId}/syncWithSchema`
        public let path: String
...
extension Paths {
    ...
    public struct Collections {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(collection: PostRequest.Collection? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(collection: collection))
        }
...
extension Paths.Collections.Fork {
    public func collectionUid(_ collectionUid: String) -> WithCollectionUid {
        WithCollectionUid(path: "\(path)/\(collectionUid)")
    }

    public struct WithCollectionUid {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(workspace: String? = nil, label: String? = nil) -> Request<Void> {
            .post(path, query: makePostQuery(workspace), body: ["label": label])
        }
...
extension Paths.Collections {
    ...
    public struct WithCollectionUid {
        ...
        public func put(collection: PutRequest.Collection? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(collection: collection))
        }
...
extension Paths {
    ...
    public struct Environments {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(environment: PostRequest.Environment? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(environment: environment))
        }
...
extension Paths.Environments {
    public func environmentUid(_ environmentUid: String) -> WithEnvironmentUid {
        WithEnvironmentUid(path: "\(path)/\(environmentUid)")
    }

    public struct WithEnvironmentUid {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(environment: PutRequest.Environment? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(environment: environment))
        }
...
extension Paths {
    ...
    public struct Mocks {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(mock: PostRequest.Mock? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(mock: mock))
        }
...
extension Paths.Mocks {
    public func mockUid(_ mockUid: String) -> WithMockUid {
        WithMockUid(path: "\(path)/\(mockUid)")
    }

    public struct WithMockUid {
        /// Path: `/mocks/{mock_uid}`
        public let path: String
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(mock: PutRequest.Mock? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(mock: mock))
        }
...
extension Paths.Mocks.WithMockUid {
    public var unpublish: Unpublish {
        Unpublish(path: path + "/unpublish")
    }

    public struct Unpublish {
        /// Path: `/mocks/{mock_uid}/unpublish`
        public let path: String
...
extension Paths {
    public static var monitors: Monitors {
    ...
    public struct Monitors {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(monitor: PostRequest.Monitor? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(monitor: monitor))
        }
...
extension Paths.Monitors {
    public func monitorUid(_ monitorUid: String) -> WithMonitorUid {
        WithMonitorUid(path: "\(path)/\(monitorUid)")
    }

    public struct WithMonitorUid {
        /// Path: `/monitors/{monitor_uid}`
        public let path: String
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func put(monitor: PutRequest.Monitor? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(monitor: monitor))
        }
...
extension Paths.Monitors.WithMonitorUid {
    public var run: Run {
        Run(path: path + "/run")
    }
...
extension Paths.Scim.V2 {
    public var resourceTypes: ResourceTypes {
        ResourceTypes(path: path + "/ResourceTypes")
    }
...
extension Paths.Scim.V2 {
    public var serviceProviderConfig: ServiceProviderConfig {
        ServiceProviderConfig(path: path + "/ServiceProviderConfig")
    }
...
extension Paths.Scim.V2.Users {
    ...
    public struct WithID {
        ...
        public func patch(_ body: PatchRequest? = nil) -> Request<PatchResponse> {
...
extension Paths.Security {
    public var apiValidation: APIValidation {
        APIValidation(path: path + "/api-validation")
    }

    public struct APIValidation {
...
extension Paths {
    ...
    public struct Webhooks {
        ...
        public func post(workspace: String? = nil, webhook: PostRequest.Webhook? = nil) -> Request<Void> {
            .post(path, query: makePostQuery(workspace), body: PostRequest(webhook: webhook))
        }
...
extension Paths {
    ...
    public struct Workspaces {
        ...
        /// 
        /// > Requires <a href="#authentication">API Key</a> as `X-Api-Key` request header or `apikey` URL query parameter.
        public func post(workspace: PostRequest.Workspace? = nil) -> Request<PostResponse> {
            .post(path, body: PostRequest(workspace: workspace))
        }
...
extension Paths.Workspaces {
    public func workspaceID(_ workspaceID: String) -> WithWorkspaceID {
        WithWorkspaceID(path: "\(path)/\(workspaceID)")
    }

    public struct WithWorkspaceID {
        ...
        public func put(workspace: PutRequest.Workspace? = nil) -> Request<PutResponse> {
            .put(path, body: PutRequest(workspace: workspace))
        }
