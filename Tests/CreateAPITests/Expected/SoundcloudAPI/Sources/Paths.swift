    ...
    public struct Connect {
        ...
        public struct GetParameters {
            ...
            public func asQuery() -> [(String, String?)] {
                ...
                query.addQueryItem("response_type", responseType.asQueryValue)
                query.addQueryItem("scope", scope.asQueryValue)
...
extension Paths.Me.Likes {
    ...
    public struct Tracks {
        ...
        private func makeGetQuery(_ limit: Int?, _ isLinkedPartitioning: Bool?) -> [(String, String?)] {
            var query: [(String, String?)] = []
            query.addQueryItem("limit", limit?.asQueryValue)
            query.addQueryItem("linked_partitioning", isLinkedPartitioning?.asQueryValue)
            return query
        }
    }
}
...
extension Paths.Me {
    ...
    public struct Followings {
        ...
        public enum GetResponse: Decodable {
            ...
            case usersList(SoundcloudAPI.UsersList)

            public init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                if let value = try? container.decode(SoundcloudAPI.Users.self) {
                    self = .users(value)
                } else if let value = try? container.decode(SoundcloudAPI.UsersList.self) {
...
extension Paths {
    ...
    public struct Tracks {
        ...
        public struct GetParameters {
            ...
            public init(q: String, ids: String? = nil, genres: String? = nil, tags: String? = nil, access: [Access]? = nil, limit: Int? = nil, offset: Int? = nil, isLinkedPartitioning: Bool? = nil) {
                self.q = q
                self.ids = ids
                self.genres = genres
                self.tags = tags
            ...
            public func asQuery() -> [(String, String?)] {
                ...
                query.addQueryItem("genres", genres?.asQueryValue)
...
extension Paths.Playlists {
    ...
    public struct WithPlaylistID {
        ...
        private func makeGetQuery(_ secretToken: String?, _ access: [Access]?) -> [(String, String?)] {
            var query: [(String, String?)] = []
            query.addQueryItem("secret_token", secretToken?.asQueryValue)
            query.addQueryItem("access", access?.map(\.asQueryValue).joined(separator: ","))
            return query
        }
...
extension Paths.Tracks.WithTrackID {
    ...
    public struct Favoriters {
        ...
        public func get(limit: Int? = nil, offset: Int? = nil) -> Request<SoundcloudAPI.UsersList> {
            .get(path, query: makeGetQuery(limit, offset))
        }
...
extension Paths.Users.WithUserID {
    ...
    public struct WebProfiles {
        ...
        public func get(limit: Int? = nil) -> Request<SoundcloudAPI.WebProfiles> {
            .get(path, query: makeGetQuery(limit))
        }
