...
extension Paths.Pet {
    ...
    public struct FindByStatus {
        ...
        public func get() -> Request<[edgecases_default.Pet]> {
            .get(path)
        }
    }
}
...
extension Paths.Pet.WithPetID {
    ...
    public struct UploadImage {
        ...
        /// uploads an image
        public func post(_ body: PostRequest) -> Request<edgecases_default.APIResponse> {
            .post(path, body: body)
        }
...
extension Paths.Store.Order {
    ...
    public struct WithOrderID {
        ...
        public func get() -> Request<edgecases_default.Order> {
            .get(path)
        }
...
extension Paths.User {
    ...
    public struct WithUsername {
        ...
        public func get() -> Request<edgecases_default.User> {
            .get(path)
        }
...
extension Paths {
    ...
    public struct Fake {
        ...
        ///
        /// To test enum parameters
        public func get(parameters: GetParameters, _ body: GetRequest) -> Request<Void> {
        ...
        public struct GetRequest: Encodable {
            /// Form parameter enum test (string)
            public var enumFormString: EnumFormString?
            /// Form parameter enum test (string array)
            public var enumFormStringArray: [EnumFormStringArrayItem]?
            /// Query parameter enum test (double)
            public var enumQueryDouble: Double?

            /// Form parameter enum test (string)
            public enum EnumFormString: String, Codable, CaseIterable {
                case abc = "_abc"
                case minusefg = "-efg"
                case xyz = "(xyz)"
            }

            public enum EnumFormStringArrayItem: String, Codable, CaseIterable {
                case greaterThan = ">"
                case dollar = "$"
            }

            public init(enumFormString: EnumFormString? = nil, enumFormStringArray: [EnumFormStringArrayItem]? = nil, enumQueryDouble: Double? = nil) {
