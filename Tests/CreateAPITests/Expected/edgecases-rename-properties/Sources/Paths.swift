...
extension Paths.Pet {
    ...
    public struct FindByStatus {
        ...
        public func get(parameters: GetParameters) -> Request<[edgecases_rename_properties.Pet]> {
...
extension Paths.Pet {
    ...
    public struct FindByStatus2 {
        ...
        ///
        /// Multiple status values can be provided with comma separated strings
        public func get(parameters: GetParameters? = nil) -> Request<[edgecases_rename_properties.Pet]> {
            .get(path, query: parameters?.asQuery())
        }
