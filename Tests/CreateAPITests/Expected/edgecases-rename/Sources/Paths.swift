...
extension Paths.Pet {
    ...
    public struct FindByStatus {
        ...
        public func get(parameters: GetParameters) -> Request<[edgecases_rename.Pet]> {
...
extension Paths.Pet {
    ...
    public struct FindByStatus2 {
        ...
        ///
        /// Multiple status values can be provided with comma separated strings
        public func get(parameters: GetParameters? = nil) -> Request<[edgecases_rename.Pet]> {
            .get(path, query: parameters?.asQuery())
        }
...
extension Paths.Pet.WithPetID {
    ...
    public struct UploadImage {
        ...
        /// Uploads an image
        public func post(_ body: PostRequest? = nil) -> Request<edgecases_rename.APIResponse> {
            .post(path, body: body)
        }
