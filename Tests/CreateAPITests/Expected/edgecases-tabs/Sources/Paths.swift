...
extension Paths.Pet.WithPetID {
	...
	public struct UploadImage {
		...
		/// uploads an image
		public func post(_ body: PostRequest) -> Request<edgecases_tabs.APIResponse> {
			.post(path, body: body)
		}
...
extension Paths.Store.Order {
	...
	public struct WithOrderID {
		...
		public func get() -> Request<edgecases_tabs.Order> {
			.get(path)
		}
...
extension Paths.User {
	...
	public struct WithUsername {
		...
		public func get() -> Request<edgecases_tabs.User> {
			.get(path)
		}
