...
public struct DeviceDetails: Codable {
    ...
    public init(clientID: String? = nil, deviceSecret: String? = nil, formFactor: FormFactor? = nil, id: String? = nil, metadata: [String: AnyJSON]? = nil, platform: Platform? = nil, pushRecipient: Recipient? = nil, pushState: PushState? = nil) {
...
public struct TokenRequest: Codable {
    ...
    ///   ]
    /// }
    public var capability: [String: AnyJSON]
    ...
    public init(capability: [String: AnyJSON], clientID: String? = nil, keyName: String, nonce: String, timestamp: Int) {
        self.capability = capability
        self.clientID = clientID
        self.keyName = keyName
        self.nonce = nonce
